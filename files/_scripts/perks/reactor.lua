...
if( energy_cur > energy_cap ) then
	if( not( EntityHasTag( hooman, "system_overload" ))) then
		...
		GamePlaySound( "mods/Noita40K/files/40K.bank", "fx/status_effects/overload/create", char_x, char_y )
...
elseif( EntityHasTag( hooman, "system_overload" )) then
	GamePlaySound( "mods/Noita40K/files/40K.bank", "fx/status_effects/overload/game_effect_end", char_x, char_y )
