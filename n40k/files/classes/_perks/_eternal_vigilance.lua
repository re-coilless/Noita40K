...
if( not( pen.is_inv_active())) then
	...
	function mode_controller()
		pic = "mods/n40k/files/pics/gui_gfx/ui_mode_button_off.png"
		if( explorator_mode ) then
			pic = "mods/n40k/files/pics/gui_gfx/ui_mode_button_on.png"
		end
		uid, clicked, r_clicked = new_button( gui, uid, 1, 18, pic_z, pic )
		if( clicked ) then
			if( explorator_mode ) then
				GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/exp_mode_off", char_x, char_y )
				new_console_entry( hooman, "[COMBAT_MODE]", 0 )
				ComponentSetValue2( ui_mode_storage, "value_bool", false )
			else
				GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/exp_mode_on", char_x, char_y )
	...
	function dendrites_controller()
		...
		pic = "mods/n40k/files/pics/gui_gfx/dendrite_state_button_B.png"
		if( dendrites_active ) then
			pic = "mods/n40k/files/pics/gui_gfx/dendrite_state_button_A.png"
		end
	...
	function energy_state()
		...
		pic = "mods/n40k/files/pics/gui_gfx/energy_system_state.png"
		...
		if( energy_percent > 0 ) then
			...
			if( energy_percent < 1 ) then
				local filler_pic = "mods/n40k/files/pics/gui_gfx/fillers/filler_energy_blue.png"
				if( energy_percent >= 0.78 ) then
					filler_pic = "mods/n40k/files/pics/gui_gfx/fillers/filler_energy_yellow.png"
				end
				...
				GuiZSetForNextWidget( gui, pic_z )
				GuiImage( gui, uid - 1, pic_x + 8, pic_y + 125, "mods/n40k/files/pics/gui_gfx/fillers/filler_energy_red.png", 1, 0.83, 1 )
				GuiZSetForNextWidget( gui, pic_z )
				GuiImage( gui, uid, pic_x + 7, pic_y + 18, "mods/n40k/files/pics/gui_gfx/fillers/filler_energy_red.png", 1, 1, 107 )
			end
		end
	end
	...
	function wand_state()
				...
				if( EntityHasTag( wand_id, "wand" ) or EntityHasTag( wand_id, "custom_wand" )) then
					...
					if( inv_slot_x < 4 and inv_slot_y == 0 ) then
						...
						if( EntityHasTag( wand_id, "mag_gun" )) then
							dofile_once( "mods/n40k/files/scripts/libs/mag_system.lua" )
		...
		for k,wand in ipairs( wand_state_matrix ) do
			...
			if( wand.ready ~= 1 ) then
				pic = "mods/n40k/files/pics/gui_gfx/fillers/filler_energy_red.png"
	...
	function captured_pointer()
		...
		if( ce_distance < 250 ) then
			pic = "mods/n40k/files/pics/gui_gfx/mark_capture.png"
			...
			pic = "mods/n40k/files/pics/gui_gfx/mark_capture_corner.png"
			pic_w, pic_h = GuiGetImageDimensions( gui, pic, 1.5 )
	...
	function anomaly_detector()
		...
		pic = "mods/n40k/files/pics/gui_gfx/basic_radar.png"
		...
		pic = "mods/n40k/files/pics/gui_gfx/fillers/filler_energy_green.png"
		pic_x = pic_x + 1
		pic_y = pic_y + 1
		...
		if( current_waypoint ~= "|" ) then
			...
			pic = "mods/n40k/files/pics/gui_gfx/fillers/filler_energy_blue.png"
	...
	function entity_scanner()
		...
		local capture_combo = mnee.mnin( "bind", { "n40k", "capture" }, { pressed = true })
				...
				if( not( capture_activated )) then
					if( t_dist < 10 ) then
						if( target_entity ~= captured_entity ) then
							GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/capture_mode_on", char_x, char_y )
							new_console_entry( hooman, "Target "..target_entity.." captured.", 0 )
							ComponentSetValue2( captured_storage, "value_int", target_entity )
						end
					else
						GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/capture_mode_off", char_x, char_y )
	...
	function servoskull_interface()
		pic_x = 42
		pic_y = 41
		if( ModSettingGetNextValue( "n40k.SHOW_PERKS" ) and GameHasFlagRun( "PERK_GUI_EV_MODE" )) then
			pic_y = pic_y + 18
		end
		...
		if( not( skull_menu_state )) then
			uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z, "mods/n40k/files/pics/gui_gfx/servoskull_button.png" )
			if( clicked ) then
			...
			{
				{
					content = function( gui, uid, pic_x, pic_y )
						...
						if( show_targeter ) then
							uid = new_image( gui, uid, pic_x + 1, pic_y + 1, pic_z - 0.01, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 14, 14 )
						end
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon.png" )
						if( clicked ) then
						...
						uid = new_image( gui, uid, pic_x + 12, pic_y + 4.5, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/servoskull_quote.png" )
				...
				},
				{
					content = function( gui, uid, pic_x, pic_y )
						...
						for i = 1,5 do
							...
							if( slot_state ~= 0 ) then
								if( saved_id == nil ) then
									uid = new_image( gui, uid, pic_x + 1, pic_y + 1, pic_z - 0.005, "mods/n40k/files/pics/gui_gfx/fillers/filler_blue.png", 14, 16 )
									slot_state = 0
								else
									uid = new_image( gui, uid, pic_x + 1, pic_y + 1, pic_z - 0.005, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 14, 16 )
								end
							end
							
							uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y + 21, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_write.png" )
							if( r_clicked ) then
							...
							uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y + 40, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_read.png" )
							if( clicked ) then
								if( slot_state == 0 ) then
									GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_failure", char_x, char_y )
							...
							if( slot_state < 0 ) then
								uid = new_image( gui, uid, pic_x + 1, pic_y + 60, pic_z - 0.01, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 14, 14 )
							end
							uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y + 59, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_lock.png" )
							if( clicked ) then
								if( slot_state ~= 0 ) then
									GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
						...
						pic_x = pic_x + 24
						pic_y = pic_y + 1
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_reset.png" )
						if( r_clicked ) then
							GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
							for i = 1,5 do
						...
						for i = 1,3 do
							...
							if( waypoint ~= "|" ) then
								if( current_waypoint == waypoint ) then
									uid = new_image( gui, uid, pic_x - 4, pic_y + ( i - 1 )*19 + 3, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/mark_waypoint.png" )
								end
								
								uid = new_image( gui, uid, pic_x + 1, pic_y + ( i - 1 )*19 + 1, pic_z - 0.01, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 14, 14 )
							end
							uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y + ( i - 1 )*19, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_waypoint_"..i..".png" )
							if( clicked ) then
								if( waypoint ~= "|" ) then
									if( current_waypoint ~= waypoint ) then
										GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
				...
				},
				{
					content = function( gui, uid, pic_x, pic_y )
						...
						uid, delta = new_side_clicker( gui, uid, char_x, char_y, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_delay.png" )
						if( wand_state ~= 0 ) then
							new_values[1] = delter( new_values[1], delta )
						end
						
						pic_x = pic_x + 31
						uid, delta = new_side_clicker( gui, uid, char_x, char_y, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_recharge.png" )
						if( wand_state ~= 0 ) then
							new_values[2] = delter( new_values[2], delta )
						end
						
						pic_y = pic_y + 19
						uid, delta = new_side_clicker( gui, uid, char_x, char_y, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_mana_max.png" )
						if( wand_state ~= 0 ) then
							new_values[3] = delter( new_values[3], 10*delta )
						end
						
						pic_x = pic_x - 31
						uid, delta = new_side_clicker( gui, uid, char_x, char_y, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_mana_up.png" )
						if( wand_state ~= 0 ) then
							new_values[4] = delter( new_values[4], 10*delta )
						end
						
						pic_y = pic_y + 19
						uid, delta = new_side_clicker( gui, uid, char_x, char_y, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_capacity.png" )
						if( wand_state ~= 0 ) then
							new_values[5] = delter( new_values[5], delta )
						end
						
						pic_x = pic_x + 31
						uid, delta = new_side_clicker( gui, uid, char_x, char_y, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_spread.png" )
						if( wand_state ~= 0 ) then
						...
						pic_x = pic_x - 31
						pic_y = pic_y + 19
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_shuffle.png" )
						if( wand_state ~= 0 ) then
						...
						pic_x = pic_x + 46
						pic_y = pic_y - 57
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_salvage.png" )
						if( r_clicked ) then
							if( wand_state ~= 0 ) then
						...
						pic_y = pic_y + 19
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_insert.png" )
						if( r_clicked ) then
							if( wand_state == 0 ) then
								if( captured_entity ~= 0 ) then
						...
						pic_y = pic_y + 19
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_extract.png" )
						if( r_clicked ) then
							if( wand_state ~= 0 ) then
								GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
								EntityRemoveTag( wand_id, "storage_wand_storage" )
						...
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_done.png" )
						if( r_clicked ) then
							if( wand_state ~= 0 ) then
				...
				},
				{
					content = function( gui, uid, pic_x, pic_y )
						...
						if( matter_count > 0 ) then
							...
							uid = new_image( gui, uid, pic_x + 1, pic_y + 74 - matter_percent, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 14, matter_percent )
						end
						...
						pic_y = pic_y + 59
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/icons/servoskull/icon_gen.png" )
						if( r_clicked ) then
			...
			pic_x = pic_x + 22
			pic_y = pic_y + 5
			uid = new_image( gui, uid, pic_x, pic_y, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/servoskull_pages.png" )
			uid = new_image( gui, uid, pic_x - 2, pic_y + 8, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/fillers/filler_solid_white.png", 3 + skull_menu_page*26, 1 )
			uid = new_image( gui, uid, pic_x + ( skull_menu_page + 1 )*26, pic_y + 8, pic_z - 0.1, "mods/n40k/files/pics/gui_gfx/fillers/filler_solid_white.png", ( 3 - skull_menu_page )*26 + 3, 1 )
			
			pic_x = pic_x + 1
			for i = 0,3 do
				uid, clicked, r_clicked = new_button( gui, uid, pic_x + i*26, pic_y, pic_z - 0.01, "mods/n40k/files/pics/gui_gfx/button_weak_gray.png" )
				if( clicked ) then
