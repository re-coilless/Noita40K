...
local anim_active = "mods/n40k/files/pics/guns_gfx/chainsword_active.xml"
local anim_passive = "mods/n40k/files/pics/guns_gfx/chainsword_passive.xml"
...
if( beam_spot_id == nil or not( EntityGetIsAlive( beam_spot_id ))) then
	beam_spot_id = EntityLoad( "mods/n40k/files/entities/projectiles/beam_spot.xml", w_x, w_y )
...
if( state ) then
	...
	shoot_projectile_ultimate( hooman, "mods/n40k/files/entities/projectiles/beam_chainsword_physical.xml", end_x, end_y, -math.cos( w_rotation )*blade_speed, -math.sin( w_rotation )*blade_speed, false )
