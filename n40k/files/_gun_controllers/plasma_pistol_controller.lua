...
if( ComponentGetValue2( abil_comp, "mana" ) < 5 ) then
	if( not( overheated )) then
		...
		GamePlaySound( "mods/n40k/files/sfx/n40k.bank", "guns/reloads/overheat_start", w_x, w_y )
...
if( overheated and delay_frame <= frame_num ) then
	GamePlaySound( "mods/n40k/files/sfx/n40k.bank", "guns/reloads/overheat_end", w_x, w_y )
