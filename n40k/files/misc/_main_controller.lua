...
dofile_once( "mods/n40k/files/scripts/libs/gui_lib.lua" )
dofile_once( "mods/n40k/files/scripts/libs/lists.lua" )
...
local quest_info_raw = ModSettingGetNextValue( "n40k.QUEST_INFO" )
local quest_info = {}
if( quest_info_raw ~= "|" ) then
	quest_info = DD_extractor( quest_info_raw, true )
end

local note_info_raw = ModSettingGetNextValue( "n40k.NOTE_INFO" )
local note_info = {}
if( note_info_raw ~= "|" ) then
	note_info = DD_extractor( note_info_raw, true )
end

local tutorial_mode = ModSettingGetNextValue( "n40k.UI_MODE" ) == 1
...
if( pen.is_inv_active()) then
	...
	{
		{
			title = "mods/n40k/files/pics/gui_gfx/main_menu_title_loadout.png",
			pic = "mods/n40k/files/pics/gui_gfx/main_menu_sign_loadout.png",
			content = function( gui, uid, pic_x, pic_y, pic_z )
				...
				local loadout = get_gun_nums( D_extractor( ModSettingGetNextValue( "n40k.CUSTOM_LOADOUT" ), true ))
				...
				for i = counter,9*page_loadout do
					for e = ( 4*i - 3 ),4*i do
						...
						if( counter <= #gun_info ) then
							...
							if( hovered ) then
								uid = new_image( gui, uid, pic_x + fancy_offset[1] - 1, pic_y + fancy_offset[2] - 1, pic_z, "mods/n40k/files/pics/gui_gfx/icons/menu/selection_hover.png" )
								selected = counter
							end
							if( gun_info[counter].unlocked ) then
								if( clicked ) then
									GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
									loadout_current = counter
								end
							else
								uid = new_image( gui, uid, pic_x + fancy_offset[1], pic_y + fancy_offset[2], pic_z - 0.01, "mods/n40k/files/pics/gui_gfx/icons/menu/icon_empty.png" )
							end
							
							if( counter == loadout_current ) then
								uid = new_image( gui, uid, pic_x + fancy_offset[1] + 1, pic_y + fancy_offset[2] + 1, pic_z + 0.01, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 23, 23 )
							end
						else
							uid = new_image( gui, uid, pic_x + fancy_offset[1], pic_y + fancy_offset[2], pic_z, "mods/n40k/files/pics/gui_gfx/icons/menu/icon_empty.png", 1, 1, 1, true )
							clicked, r_clicked, hovered = GuiGetPreviousWidgetInfo( gui )
							if( hovered ) then
								uid = new_image( gui, uid, pic_x + fancy_offset[1] - 1, pic_y + fancy_offset[2] - 1, pic_z, "mods/n40k/files/pics/gui_gfx/icons/menu/selection_hover.png" )
								selected = -1
				...
				pic_y = pic_y - 2
				for i = 1,4 do
					uid = new_image( gui, uid, pic_x - 1, pic_y + ( i - 1 )*30 - 1, pic_z, "mods/n40k/files/pics/gui_gfx/icons/menu/selection_special.png" )
					...
					if( loadout[i] == loadout_temp[i] ) then
						uid = new_image( gui, uid, pic_x + 1, pic_y + ( i - 1 )*30 + 1, pic_z + 0.01, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 23, 23 )
					end
				end
				
				uid, clicked, r_clicked = new_button( gui, uid, pic_x + 2, pic_y + 117, pic_z, "mods/n40k/files/pics/gui_gfx/main_menu_button_holo_done.png" )
				uid = new_tutorial_tooltip( gui, uid, "LMB to confirm." )
				if( clicked ) then
					GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
					ModSettingSetNextValue( "n40k.CUSTOM_LOADOUT", D_packer( get_gun_ids( loadout_temp )), false )
				end
				...
				pic_y = pic_y + 32
				uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z, "mods/n40k/files/pics/gui_gfx/main_menu_button_holo_previous.png" )
				...
				uid, clicked, r_clicked = new_button( gui, uid, pic_x + 34, pic_y, pic_z, "mods/n40k/files/pics/gui_gfx/main_menu_button_holo_next.png" )
				if( clicked and #gun_info > 36 ) then
					GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
					page_loadout = page_loadout + 1
		...
		{
			title = "mods/n40k/files/pics/gui_gfx/main_menu_title_classes.png",
			pic = "mods/n40k/files/pics/gui_gfx/main_menu_sign_classes.png",
			content = function( gui, uid, pic_x, pic_y, pic_z )
				local counter = 1
				local stats = DD_extractor( ModSettingGetNextValue( "n40k.CLASS_STATS" ))
				local current = { ModSettingGetNextValue( "n40k.CURRENT_CLASS" ), ModSettingGetNextValue( "n40k.CURRENT_SKIN" ), }
				...
				function skin_scroller( gui, uid, pic_x, pic_y, pic_z, class )
					...
					pic_x = pic_x + 8
					pic_y = pic_y + 12
					uid, clicked, r_clicked = new_button( gui, uid, pic_x + 2, pic_y, pic_z, "mods/n40k/files/pics/gui_gfx/main_menu_button_holo_up.png" )
					...
					for i = 1,8 do
						...
						if(( selected_skin or 0 ) == list_num ) then
							uid = new_image( gui, uid, pic_x - 1, pic_y + ( i - 1 )*30 - 1, pic_z + 0.01, "mods/n40k/files/pics/gui_gfx/icons/menu/selection_special.png" )
						end
						...
						if( hovered ) then
							uid = new_image( gui, uid, pic_x - 1, pic_y + ( i - 1 )*30 - 1, pic_z, "mods/n40k/files/pics/gui_gfx/icons/menu/selection_hover.png" )
						end
						if( class.skins[list_num].unlocked ) then
							...
							if( r_clicked ) then
								GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
								ModSettingSetNextValue( "n40k.CURRENT_SKIN", list_num, false )
								perk_page_class = nil
							end
						else
							uid = new_image( gui, uid, pic_x, pic_y + ( i - 1 )*30, pic_z - 0.01, "mods/n40k/files/pics/gui_gfx/icons/menu/icon_empty.png" )
						end
					...
					pic_y = pic_y + 239
					uid, clicked, r_clicked = new_button( gui, uid, pic_x + 2, pic_y, pic_z, "mods/n40k/files/pics/gui_gfx/main_menu_button_holo_down.png" )
					uid = new_tutorial_tooltip( gui, uid, "LMB to scroll singulars. / RMB to scroll pages. /" )
					if( #class.skins > 8 ) then
						if( clicked ) then
							GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
				...
				if( selected_skin == nil ) then
						...
						for e = 1,3 do
							if( #class_info[counter].skins > 0 ) then
								if( counter == current[1] ) then
									uid = new_image( gui, uid, pic_x + ( e - 1 )*30 + 1, pic_y + ( i - 1 )*30 + 1, pic_z + 0.01, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 23, 23 )
							...
							if( hovered ) then
								uid = new_image( gui, uid, pic_x + ( e - 1 )*30 - 1, pic_y + ( i - 1 )*30 - 1, pic_z, "mods/n40k/files/pics/gui_gfx/icons/menu/selection_hover.png" )
								selected_class = counter
							end
							if( stats[counter][1] == 1 ) then
								if( clicked and #class_info[counter].skins > 0 ) then
									GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
									ModSettingSetNextValue( "n40k.CURRENT_CLASS", counter, false )
									ModSettingSetNextValue( "n40k.CURRENT_SKIN", class_info[counter].default_skin, false )
									perk_page_class = nil
									skin_pos = nil
								end
							else
								uid = new_image( gui, uid, pic_x + ( e - 1 )*30, pic_y + ( i - 1 )*30, pic_z - 0.01, "mods/n40k/files/pics/gui_gfx/icons/menu/icon_empty.png" )
							end
					...
					function perk_scroller_vertical( gui, uid, pic_x, pic_y, pic_z, visual_perks )
						...
						pic_y = pic_y + 72
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z, "mods/n40k/files/pics/gui_gfx/main_menu_button_holo_previous_perk.png" )
						if( clicked ) then
							GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
						...
						pic_x = pic_x + 18
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z, "mods/n40k/files/pics/gui_gfx/main_menu_button_holo_next_perk.png" )
						if( clicked ) then
							GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
							perk_page_class = perk_page_class - 1
					...
					uid, clicked, r_clicked = new_button( gui, uid, pic_x + 160, pic_y + 4, pic_z, "mods/n40k/files/pics/gui_gfx/main_menu_button_holo_close_skin.png" )
					if( clicked ) then
						GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
						gonna_close = true
					end
					...
					function perk_scroller_horizontal( gui, uid, pic_x, pic_y, pic_z, visual_perks )
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z, "mods/n40k/files/pics/gui_gfx/button_side_large.png" )
						if( clicked ) then
							GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
						...
						uid, clicked, r_clicked = new_button( gui, uid, pic_x + 46, pic_y, pic_z, "mods/n40k/files/pics/gui_gfx/button_side_large.png" )
						if( clicked ) then
							GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
							perk_page_skin = perk_page_skin + 1
		...
		{
			title = "mods/n40k/files/pics/gui_gfx/main_menu_title_codex.png",
			pic = "mods/n40k/files/pics/gui_gfx/main_menu_sign_codex.png",
			content = function( gui, uid, pic_x, pic_y, pic_z )
					...
					for i = 1,7 do
						...
						if( list_num <= #entries ) then
							...
							if( add_frame ) then
								...
								uid = new_image( gui, uid, pic_x, pic_y + ( i - 1 )*30, pic_z, "mods/n40k/files/pics/gui_gfx/icons/menu/icon.png", 1, 1, 1, true )
							else
				...
				for i,page in ipairs( codex_structure ) do
					if( codex_page == i ) then
						uid = new_image( gui, uid, pic_x + ( i - 1 )*30 + 1, pic_y + 1, pic_z + 0.01, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 23, 23 )
					end
					uid = new_image( gui, uid, pic_x + ( i - 1 )*30, pic_y, pic_z, page.main_icon, 1, 1, 1, true )
					clicked, r_clicked, hovered = GuiGetPreviousWidgetInfo( gui )
					uid = new_tooltip( gui, uid, page.name )
					if( hovered ) then
						uid = new_image( gui, uid, pic_x + ( i - 1 )*30 - 1, pic_y - 1, pic_z, "mods/n40k/files/pics/gui_gfx/icons/menu/selection_hover.png" )
					end
					if( clicked ) then
						GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
						codex_page = i
				...
				pic_y = pic_y + 27
				uid = new_image( gui, uid, pic_x, pic_y, pic_z, "mods/n40k/files/pics/gui_gfx/fillers/filler_solid_white.png", 175, 1 )
				...
				local codex_pages =
				{
					function( gui, uid, pic_x, pic_y, pic_z )
						...
						uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y + 242, pic_z, "mods/n40k/files/pics/gui_gfx/main_menu_button_holo_previous_long.png" )
						...
						uid, clicked, r_clicked = new_button( gui, uid, pic_x + 88, pic_y + 242, pic_z, "mods/n40k/files/pics/gui_gfx/main_menu_button_holo_next_long.png" )
						if( segment > 1 and clicked ) then
							GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
							info_page = info_page + 1
							if( info_page > segment ) then
	...
	if( not( menu_state or quest_state )) then
		pic = "mods/n40k/files/pics/gui_gfx/main_menu_button_main.png"
		pic_w, pic_h = GuiGetImageDimensions( gui, pic, 1 )
		pic_x = w - ( pic_w + 1 )
		pic_y = 1
		uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z, pic )
		if( clicked ) then
			GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/menu_open", char_x, char_y )
			ComponentSetValue2( menu_state_storage, "value_bool", true )
		end
		
		if( quest_info_raw ~= "|" ) then
			pic = "mods/n40k/files/pics/gui_gfx/quest_menu_button_main.png"
			pic_w, pic_h = GuiGetImageDimensions( gui, pic, 1 )
			pic_x = pic_x - ( pic_w + 1 )
			uid, clicked, r_clicked = new_button( gui, uid, pic_x, pic_y, pic_z, pic )
			if( clicked ) then
	...
	elseif( quest_state ) then
		...
		if( #quest_info > 0 ) then
			uid, clicked, r_clicked = new_button( gui, uid, pic_x + 1, pic_y + 8, pic_z, "mods/n40k/files/pics/gui_gfx/quest_menu_button_holo_up.png" )
			uid = new_tutorial_tooltip( gui, uid, "LMB to scroll singulars. / RMB to scroll pages. /" )
			...
			for i = 1,5 do
				if( list_num <= #quest_info ) then
					if( current_quest == list_num ) then
						uid = new_image( gui, uid, pic_x + 2, pic_y + ( i - 1 )*17 + 21, pic_z + 0.01, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 14, 14 )
					end
					...
					if( panel_state == tonumber( quest_info[list_num][1] )) then
						uid = new_image( gui, uid, pic_x, pic_y + ( i - 1 )*17 + 19, pic_z, "mods/n40k/files/pics/gui_gfx/icons/menu/selection_hover_small.png" )
					end
					if( clicked ) then
						GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
			...
			uid, clicked, r_clicked = new_button( gui, uid, pic_x + 1, pic_y + 106, pic_z, "mods/n40k/files/pics/gui_gfx/quest_menu_button_holo_down.png" )
			uid = new_tutorial_tooltip( gui, uid, "LMB to scroll singulars. / RMB to scroll pages. /" )
			if( #quest_info > 5 ) then
				if( clicked ) then
					GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
		...
		uid, clicked, r_clicked = new_button( gui, uid, pic_x + 191, pic_y + 3, pic_z, "mods/n40k/files/pics/gui_gfx/quest_menu_button_holo_close.png" )
		if( clicked ) then
			GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
		...
		if( #quest_info > 0 ) then
			...
			if( gonna_remove == current_quest ) then
				...
				uid = new_image( gui, uid, pic_x + 10, pic_y + 12, pic_z - 0.01, "mods/n40k/files/pics/gui_gfx/quest_menu_button_holo_delete.png" )
				if( clicked ) then
					GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_button", char_x, char_y )
					gonna_remove = 0
				elseif( r_clicked ) then
					GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_failure", char_x, char_y )
			...
			if( panel_state == tonumber( quest_info[current_quest][1] )) then
				uid = new_image( gui, uid, pic_x + 192, pic_y + 106, pic_z + 0.01, "mods/n40k/files/pics/gui_gfx/fillers/filler_red.png", 10, 10 )
			elseif( tutorial_mode ) then
				new_blinker( gui, { 195/255, 3/255, 3/255, 1 } )
			end
			uid, clicked, r_clicked = new_button( gui, uid, pic_x + 191, pic_y + 105, pic_z, "mods/n40k/files/pics/gui_gfx/quest_menu_button_holo_pin.png" )
			if( clicked ) then
				if( panel_state == tonumber( quest_info[current_quest][1] )) then
					GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/holo_failure", char_x, char_y )
		...
		close_action = function()
			...
			GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/menu_close", char_x, char_y )
		end
		next_action = function()
			...
			GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/forward", char_x, char_y )
		end
...
if( #quest_info > 0 ) then
	for i,q in ipairs( quest_info ) do
		if( get_quest_with_id( q[2] ).winner( q[1], hooman, char_x, char_y, q[6], q[7], q[8], q[9] )) then
			GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/quest_end", char_x, char_y )
...
if( #note_info > 0 ) then
	if( frame_num > note_cooldown ) then
		GamePrintImportant( note_info[1][1], note_info[1][2], "mods/n40k/files/pics/gui_gfx/window_modules/3piece_custom_A.png" )
		if( note_info[1][3] == "1" ) then
			GamePlaySound( "mods/n40k/files/40K.bank", "fx/ui/note", char_x, char_y )
		end
		table.remove( note_info, 1 )
		ModSettingSetNextValue( "n40k.NOTE_INFO", DD_packer( note_info ), false )
