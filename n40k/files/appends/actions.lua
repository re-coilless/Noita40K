...
function n40k.muzzle_flash( muzzle_x, muzzle_y, r, s_x, s_y, gun_id, card_id, action )
	-- use action.muzzle_flash to apply projectile-based flash mutation
	local v_x, v_y = pen.get_speed( EntityGetRootEntity( gun_id ))
	local flash_func = n40k.MUZZLE_FLASHES[ EntityGetName( gun_id )]
	return ( flash_func or n40k.MUZZLE_FLASHES.bolter )( muzzle_x, muzzle_y, r, v_x, v_y, gun_id )
end

table.insert( actions,
{
	id = "N40K_BOLT_75_HE_S",
	name = "$n40k_MAG_bolt_75_he_s", description = "$n40k_MAG_bolt_75_he_s_",
	sprite = "mods/n40k/files/items/mags/bolt_75_he_S.png",
	...
	projectiles = {{ p = "mods/n40k/files/items/rounds/bolt_75_he.xml", r = 0.75, h = 0.25 }},
	custom_xml_file = "mods/n40k/files/items/mags/bolt_75_he_S.xml",
...
table.insert( actions,
{
	id = "N40K_BOLT_998_HE_M",
	name = "$n40k_MAG_bolt_998_he_m", description = "$n40k_MAG_bolt_998_he_m_",
	sprite = "mods/n40k/files/items/mags/bolt_998_he_M.png",
...
table.insert( actions,
{
	id = "N40K_BOLT_998_HEI_M",
	name = "$n40k_MAG_bolt_998_hei_m", description = "$n40k_MAG_bolt_998_hei_m_",
	sprite = "mods/n40k/files/items/mags/bolt_998_hei_M.png",
...
table.insert( actions,
{
	id = "N40K_BOLT_998_STASIS_M",
	name = "$n40k_MAG_bolt_998_stasis_m", description = "$n40k_MAG_bolt_998_stasis_m_",
	sprite = "mods/n40k/files/items/mags/bolt_998_stasis_M.png",
...
table.insert( actions,
{
	id = "N40K_BOLT_998L_APDS_S",
	name = "$n40k_MAG_bolt_998l_apds_s", description = "$n40k_MAG_bolt_998l_apds_s_",
	sprite = "mods/n40k/files/items/mags/bolt_998L_apds_S.png",
	
	mod = "Noita40K",
	type = ACTION_TYPE_PROJECTILE,
	price = 350, mana = 0, max_uses = -1,
	spawn_requires_flag = "never_spawn_this_action",
	shells = { "mods/n40k/files/items/rounds/bolt_998Lc.xml" },
	projectiles = {{ p = "mods/n40k/files/items/rounds/bolt_998L_apds.xml", r = 4.5, h = 7 }},
	custom_xml_file = "mods/n40k/files/items/mags/bolt_998L_apds_S.xml",
	sfx = { "mods/n40k/files/n40k.bank", "items/guns/bolt_998L", false, "items/guns/dryfire" },
...
table.insert( actions,
{
	id = "N40K_BOLT_50MM_APHE_S",
	name = "$n40k_MAG_bolt_50mm_aphe_s", description = "$n40k_MAG_bolt_50mm_aphe_s_",
	sprite = "mods/n40k/files/items/mags/bolt_50mm_aphe_S.png",
	
	mod = "Noita40K",
	type = ACTION_TYPE_PROJECTILE,
	price = 400, mana = 0, max_uses = -1,
	spawn_requires_flag = "never_spawn_this_action",
	shells = { "mods/n40k/files/items/rounds/bolt_50mmc.xml" },
	projectiles = {{ p = "mods/n40k/files/items/rounds/bolt_50mm_aphe.xml", r = 12, h = 50 }},
	custom_xml_file = "mods/n40k/files/items/mags/bolt_50mm_aphe_S.xml",
	sfx = { "mods/n40k/files/n40k.bank", "items/guns/bolt_50mm", false, "items/guns/dryfire" },
...
table.insert( actions,
{
	id = "N40K_CANISTER_S_PYRUM",
	name = "$n40k_MAG_canister_s_pyrum", description = "$n40k_MAG_canister_s_pyrum_",
	sprite = "mods/n40k/files/items/mags/canister_S_pyrum.png",
	...
	beam = { dmg = 0.3, dmg_type = "DAMAGE_MATERIAL", dmg_msg = "melta", dmg_effect = "NORMAL",
		...
		point_action = function( data, point_x, point_y, k, is_final )
			...
			local effect = "mods/n40k/files/items/rounds/effect_pyrum_small.xml"
	...
	custom_xml_file = "mods/n40k/files/items/mags/canister_S_pyrum.xml",
...
table.insert( actions,
{
	id = "N40K_CANISTER_M_PYRUM",
	name = "$n40k_MAG_canister_m_pyrum", description = "$n40k_MAG_canister_m_pyrum_",
	sprite = "mods/n40k/files/items/mags/canister_M_pyrum.png",
	...
	beam = { dmg = 0.6, dmg_type = "DAMAGE_MATERIAL", dmg_msg = "melta", dmg_effect = "NORMAL",
		...
		point_action = function( data, point_x, point_y, k, is_final )
			if( k%5 ~= 0 and not( is_final )) then return end
			local effect = "mods/n40k/files/items/rounds/effect_pyrum_medium.xml"
			pen.life_support( pen.c.beam_eff_ids, data.gun..k, effect, point_x, point_y )
		end, f = function( data, hit_id, hit_x, hit_y )
			pen.play_sound( pen.S.N40K.EFFECT_BURST, hit_x, hit_y )
		end,
	},
	custom_xml_file = "mods/n40k/files/items/mags/canister_M_pyrum.xml",
	sfx = { "mods/n40k/files/n40k.bank",
		"items/beams/pyrum", true, "items/guns/dryfire_energy", "items/overheat_start" },
	action = function() pen.gunshot( n40k.beamshot ) end,
})
...
table.insert( actions,
{
	id = "N40K_PACK_S_HIGH_DENSITY",
	name = "$n40k_MAG_pack_s_high_density", description = "$n40k_MAG_pack_s_high_density_",
	sprite = "mods/n40k/files/items/mags/pack_S_high_density.png",
...
table.insert( actions,
{
	id = "N40K_PACK_M_WARPBORN_PHOTON",
	name = "$n40k_MAG_pack_m_warpborn_photon", description = "$n40k_MAG_pack_m_warpborn_photon_",
	sprite = "mods/n40k/files/items/mags/pack_M_warpborn_photon.png",
	...
	beam = { dmg = 1, dmg_type = "DAMAGE_MATERIAL", dmg_msg = "darkfire", dmg_effect = "BLOOD_EXPLOSION",
		...
		point_action = function( data, point_x, point_y, k, is_final )
			EntityLoad( "mods/n40k/files/items/rounds/effect_darkfire_eater.xml", point_x, point_y )
			if( k%2 == 1 ) then return end
			EntityLoad( "mods/n40k/files/items/rounds/effect_darkfire_corruptor.xml", point_x, point_y )
		end, f = function( data, hit_id, hit_x, hit_y )
			...
			-- 	LoadGameEffectEntityTo( deadman, "mods/n40k/files/entities/status_effects/effect_warpfire.xml" )
			-- end
		end,
	},
	custom_xml_file = "mods/n40k/files/items/mags/pack_M_warpborn_photon.xml",
	sfx = { "mods/n40k/files/n40k.bank",
...
table.insert( actions,
{
	id = "N40K_BATTERY_L_MULTI",
	name = "$n40k_MAG_battery_l_multi", description = "$n40k_MAG_battery_l_multi_",
	sprite = "mods/n40k/files/items/mags/battery_L_multi.png",
	...
	beam = { dmg = 0.04, dmg_type = "DAMAGE_PROJECTILE", dmg_msg = "lasfire", dmg_effect = "NORMAL",
		...
		point_action = function( data, point_x, point_y, k, is_final )
			...
			local effect = "mods/n40k/files/items/rounds/effect_lasgun_large.xml"
			pen.life_support( pen.c.beam_eff_ids, data.gun..k, effect, point_x, point_y )
		end, f = function( data, hit_id, hit_x, hit_y )
			pen.play_sound( pen.S.N40K.EFFECT_BURST, hit_x, hit_y )
	...
	custom_xml_file = "mods/n40k/files/items/mags/battery_L_multi.xml",
	sfx = { "mods/n40k/files/n40k.bank",
...
table.insert( actions, n40k.init_empty_action( "N40K_BLADE_ADAMANTIUM_TEETH", {
	cost = 50,
	name = "$n40k_MAG_blade_adamantium_teeth",
	desc = "$n40k_MAG_blade_adamantium_teeth_",
	pic = "mods/n40k/files/items/mags/blade_adamantium_teeth.png",
	card = "mods/n40k/files/items/mags/blade_adamantium_teeth.xml",
}))

table.insert( actions, n40k.init_empty_action( "N40K_CRYSTAL_S_SOLLEX", {
	cost = 10,
	name = "$n40k_MAG_crystal_s_sollex",
	desc = "$n40k_MAG_crystal_s_sollex_",
	pic = "mods/n40k/files/items/mags/crystal_S_sollex.png",
	card = "mods/n40k/files/items/mags/crystal_S_sollex.xml",
}))