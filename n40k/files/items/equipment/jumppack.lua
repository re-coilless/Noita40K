if( index.M.is_updating ) then
	...
	return function( info )
		...
		if( heat > max_heat ) then
			pen.play_sound( pen.S.N40K.OVERHEAT_START, pack_x, pack_y )
		...
		local will_dash = mnee.mnin( "bind", { "n40k", "jumppack" }, { pressed = true })
		...
		-- GamePlaySound( "mods/n40k/files/n40k.bank", "player/jumppack/ignition", char_x, char_y )
		...
		pen.play_sound( pen.S.N40K.ITEM_JUMPPACK, pack_x, pack_y )
