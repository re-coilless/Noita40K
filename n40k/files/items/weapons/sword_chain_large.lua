return function( info )
    ...
    ComponentSetValue2( pics[1], "image_file", "mods/n40k/files/items/weapons/sword_chain_large_"..anim..".png" )
    EntityRefreshSprite( info.id, pics[1])
    ComponentSetValue2( pics[2], "image_file", "mods/n40k/files/items/weapons/sword_chain_large_"..anim.."_heat.png" )
