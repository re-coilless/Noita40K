...
if( state ) then
	...
	GamePlaySound( "mods/Noita40K/files/40K.bank", "projectiles/darkfire/beam_start", barrel_x, barrel_y )
	GameScreenshake( 6 )
...
if( empty and reload_frame < frame_num ) then
	GamePlaySound( "mods/Noita40K/files/40K.bank", "guns/reloads/darkfire_reload_end", w_x, w_y )
